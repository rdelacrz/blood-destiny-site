...
import jackSmithIcon from '@/assets/images/characters/jack_smith_icon.png';
import jackSmith from '@/assets/images/characters/jack_smith.png';
import fuyumiTomoeIcon from '@/assets/images/characters/fuyumi_tomoe_icon.png';
import fuyumiTomoe from '@/assets/images/characters/fuyumi_tomoe.png';
import lionhartFreemanIcon from '@/assets/images/characters/lionhart_freeman_icon.png';
import lionhartFreeman from '@/assets/images/characters/lionhart_freeman.png';
import denzelGrayIcon from '@/assets/images/characters/denzel_gray_icon.png';
import denzelGray from '@/assets/images/characters/denzel_gray.png';
import opheliaSnowIcon from '@/assets/images/characters/ophelia_snow_icon.png';
import opheliaSnow from '@/assets/images/characters/ophelia_snow.png';
import naomiItoIcon from '@/assets/images/characters/naomi_ito_icon.png';
import naomiIto from '@/assets/images/characters/naomi_ito.png';

export interface CharactersModuleState {
  characters: Character[];
}

export const CharactersModule: Module<CharactersModuleState, RootState> = {
  namespaced: true,
  state: {
    characters: [
      {
      ...
      },
      {
        ...
        icon: fuyumiTomoeIcon,
        illustration: fuyumiTomoe,
      },
      {
        ...
        `,
        icon: lionhartFreemanIcon,
        illustration: lionhartFreeman,
      },
      {
        name: 'Denzel Gray',
        description: `
      ...
      },
      {
        ...
        `,
        icon: opheliaSnowIcon,
        illustration: opheliaSnow,
      },
      {
        name: 'Naomi Ito',
        description: `
