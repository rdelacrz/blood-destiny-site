<template>
  <Page wrapperClass='soundtrack-wrapper container'>
    <div class='playlist-details-wrapper'>
      ...
      <div class='playlist-description-container'>
        ...
        <AppButton id='playSoundtrackBtn' buttonType='play' @click='() => playSoundtrack()'>Play</AppButton>
      </div>
    </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const { selectPreviousSong, selectNextSong, selectRandomSong, selectSpecificSong } = useMutations([
      'selectPreviousSong', 'selectNextSong', 'selectRandomSong', 'selectSpecificSong'
    ]);
