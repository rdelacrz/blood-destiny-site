        ...
        <div
          ...
          <div
            ...
            <svg
              ...
              <template v-else-if="f.motif === 'crest'"><path d="M20 4l14 6v10c0 9-6 14-14 16-8-2-14-7-14-16V10z" /></template>
              <template v-else-if="f.motif === 'blade'"><path d="M30 6L14 22l-4 8 8-4L34 10zM12 28l-4 6" /></template>
              <template v-else>
