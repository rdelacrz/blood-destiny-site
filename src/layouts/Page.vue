<template>
  <div class='page-wrapper' :style="{'background-image': `url(${background})`}">
    ...
    <PageHeader />
    <main :class="['page-content-wrapper', wrapperClass]">
      <slot></slot>
    </main>
  </div>
</template>
...
export default defineComponent({
  ...
  components: {
    AlertModal: defineAsyncComponent(() => import('@/components/AlertModal.vue')),
    PageHeader: defineAsyncComponent(() => import('@/components/Header.vue')),
  },
  computed: {
    ...mapState(['popupParam']),
  },
