...
/* =================================================================
   ...
   ================================================================= */
export function mountEmbers(container: HTMLElement | null, count?: number): FxController {
...
/* =================================================================
   ...
   ================================================================= */
export function mountHaze(container: HTMLElement | null): FxController {
  if (!container) return noopController();
  const layer = document.createElement("div");
...
/* =================================================================
   ...
   ================================================================= */
export function mountShards(container: HTMLElement | null, count?: number): SimpleController {
...
export function mountParallax(host: HTMLElement | null, layers: ParallaxLayer[]): SimpleController {
...
export function revealWords(el: HTMLElement | null, opt: RevealWordsOptions = {}): void {
  if (!el) return;
...
/* =================================================================
   ...
   ================================================================= */
export function routeSweep(): void {
